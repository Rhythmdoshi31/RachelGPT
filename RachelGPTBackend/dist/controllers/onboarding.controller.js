...
export async function saveStyleProfile(req, res) {
    try {
        ...
        const { preferences, experimentingWith, lifestyle, occasions, desiredAppearance, summary, } = req.body;
...
export async function getStyleProfile(req, res) {
    try {
        const userId = req.userId;
        if (!userId) {
            return res.status(401).json({
